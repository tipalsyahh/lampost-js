...
const res=await fetch('https://lampost.co/microweb/universitaslampung/wp-json/wp/v2/posts?per_page=5&orderby=date&order=desc&_embed');
...
const link=`berita.unila.html?${kategoriSlug}/${post.slug}`;
