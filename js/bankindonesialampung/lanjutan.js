document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    const catRes = await fetch(
      'https://lampost.co/microweb/bankindonesialampung/wp-json/wp/v2/categories?slug=berita-utama'
    );
    ...
    posts.forEach(post => {
      ...
      /* 🔗 LINK DETAIL */
      const link = `berita.bankindonesialampung.html?${categorySlug}/${slug}`;
